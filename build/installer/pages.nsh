...
Function AudioDeckWelcomeCreate
  ...
  ${AdText} 246 24 450 46 $AdFontH1 ${AD_INK} ${AD_PAPER} ${SS_CENTERIMAGE} "YOUR AUDIO"
  Pop $0
  ${AdText} 246 66 450 46 $AdFontH1 ${AD_INK} ${AD_PAPER} ${SS_CENTERIMAGE} "DEVICES,"
  Pop $0
  ${AdText} 246 108 450 46 $AdFontH1 ${AD_INK} ${AD_PAPER} ${SS_CENTERIMAGE} "RANKED."
  Pop $0
  ${AdText} 246 166 440 54 $AdFontBody ${AD_INK} ${AD_PAPER} 0 \
  ...
  Pop $0
  ${AdText} 301 318 230 16 $AdFontFine ${AD_DEADINK} ${AD_SHEET} 0 "NVIDIA HIGH DEFINITION"
  Pop $0
  ...
  ${AdText} 500 339 172 32 $AdFontFine ${AD_DEADINK} ${AD_DEAD} \
    "${SS_RIGHT}|${SS_CENTERIMAGE}" "NOT PLUGGED IN"
  Pop $0
...
Function AudioDeckFolderCreate
  ...
  ${AdText} 246 26 450 56 $AdFontH1 ${AD_INK} ${AD_PAPER} ${SS_CENTERIMAGE} "WHERE IT GOES"
  Pop $0
  ${AdText} 246 92 440 54 $AdFontBody ${AD_INK} ${AD_PAPER} 0 \
  ...
  ${AdText} 246 220 200 30 $AdFontFine ${AD_DEADINK} ${AD_PAPER} ${SS_CENTERIMAGE} \
    "184 MB NEEDED"
  Pop $0
...
Function AudioDeckEffectsCreate
  ...
  ${AdText} 246 26 450 56 $AdFontH1 ${AD_INK} ${AD_PAPER} ${SS_CENTERIMAGE} "AUDIO EFFECTS"
  Pop $0
  ${AdText} 246 92 440 80 $AdFontBody ${AD_INK} ${AD_PAPER} 0 \
...
Equalizer APO, bundled here, so there is nothing to download."
  ...
  ${AdRect} 246 186 34 34 ${AD_INK}
  ${AdButton} $AdEffectsBox 249 189 28 28 ${AD_INK} ${AD_MARKER} AdOnToggleEffects "X"
  ${AdText} 294 186 390 34 $AdFontLabel ${AD_INK} ${AD_PAPER} ${SS_CENTERIMAGE} \
    "SET UP AUDIO EFFECTS"
  Pop $0
  ${AdText} 294 224 390 26 $AdFontFine ${AD_DEADINK} ${AD_PAPER} ${SS_CENTERIMAGE} \
...
Function AudioDeckFinishCreate
  ...
  ${AdText} 246 26 450 56 $AdFontH1 ${AD_INK} ${AD_PAPER} ${SS_CENTERIMAGE} "READY."
  Pop $0
  ${AdText} 246 92 440 80 $AdFontBody ${AD_INK} ${AD_PAPER} 0 \
...
at first, so click the arrow there and drag it out."
  ...
  ${AdText} 300 196 200 48 $AdFontLabel ${AD_MARKER} ${AD_INK} ${SS_CENTERIMAGE} "LOOK HERE"
  Pop $0
  ${AdText} 560 196 114 48 $AdFontFine ${AD_CAPTXT} ${AD_INK} \
    "${SS_RIGHT}|${SS_CENTERIMAGE}" "03:46"
  Pop $0

  StrCpy $AdRunWanted 1
  ${AdRect} 246 268 34 34 ${AD_INK}
  ${AdButton} $AdRunBox 249 271 28 28 ${AD_INK} ${AD_MARKER} AdOnToggleRun "X"
  ${AdText} 294 268 390 34 $AdFontLabel ${AD_INK} ${AD_PAPER} ${SS_CENTERIMAGE} \
    "OPEN AUDIODECK NOW"
  Pop $0
